...
public class MessagesController extends HelloUI {
    ...
    private void showMessages() {
        ...
        for(Message msg : messages) {
            ...
            output.insert(0, HelloUI.prepareMessageStripe(user, msg.getContent(), new SimpleDateFormat("yyyy-MM-dd HH:mm").format(msg.getSendTime()), color, HelloSession.getHtmlAvatar()));
            n++;
        }
